    ...
    return (
        <footer className=" text-gray-300 border-t border-gray-800">
            <div className="container mx-auto px-4 py-12">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    >
                        <div className="flex items-center">
                            <div className="bg-blue-600 h-8 w-8 rounded flex items-center justify-center mr-2">
                            ...
                            <span className="text-white font-bold text-xl">DocSimplify</span>
                        </div>
                    ...
                    >
                        ...
                        <a href="https://github.com/ayushdixit23" target='_blank' className="text-gray-400 hover:text-white transition-colors duration-300">
                        ...
                        <a href="https://www.linkedin.com/in/ayushdixitdev/" target='_blank' className="text-gray-400 hover:text-white transition-colors duration-300">
                ...
                >
                    <div className="flex flex-col md:flex-row justify-between items-center">
                        <p>&copy; {currentYear} DocSimplify. All rights reserved.</p>
